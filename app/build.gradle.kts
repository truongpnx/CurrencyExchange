...
dependencies {
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.9.0") // For coroutines
    implementation("com.squareup.retrofit2:retrofit:2.11.0") // For networking
